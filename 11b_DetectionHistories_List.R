...
#    first year occupancy probabilities (Felix recommmend this, so I want to 
...
species_list <- as.character(unique(obs_sub$Species))
     # there's 145 entries, but I still neeed to clean up the codes
...
# see which birds are detected at different precents
     ...
     # 5% of the time
     DPs_05 <- firstyear_DPs[firstyear_DPs>=5]  # that's 31 species...
